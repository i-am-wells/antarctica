...
function Game:fade(startAlpha, endAlpha, frames)
    ...
    -- TODO map draw should be its own function
    self.map:drawLayerAtCameraObject(self.tileImage, 0, self.engine.vw, self.engine.vh, 0)
    self.map:drawObjectsAtCameraObject(self.tileImage, 1, self.engine.vw, self.engine.vh, 0)
